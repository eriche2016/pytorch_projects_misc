...
parser.add_argument('-cuda_or_not', action='store_true', default=True, help='disable the gpu' )
# option
...
args.cuda = args.cuda_or_not and torch.cuda.is_available(); del args.cuda_or_not
