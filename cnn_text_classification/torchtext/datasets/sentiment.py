...
class SST(data.ZipDataset):
    ...
    dirname = 'trees'
    # self is used to acess instance attributes
    # cls is used to access class stuff, like url 
    ...
    def __init__(self, path, text_field, label_field, subtrees=False,
        ...
        # do preprocessing on label_field 
        label_field.preprocessing = data.Pipeline(get_label_str)

        # open the given file, and loads data and stores it to examples 
